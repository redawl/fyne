...
uintptr_t processFn(struct fnargs *args, char *parg) {
  ...
  case glfnBindVertexArray:
    ...
    break;
  case glfnBlendColor:
    glBlendColor(*(GLfloat *)&args->a0, *(GLfloat *)&args->a1,
                 *(GLfloat *)&args->a2, *(GLfloat *)&args->a3);
    break;
  case glfnBlendFunc:
    glBlendFunc((GLenum)args->a0, (GLenum)args->a1);
    break;
  case glfnBufferData:
    glBufferData((GLenum)args->a0, (GLsizeiptr)args->a1, (GLvoid *)parg,
                 (GLenum)args->a2);
    break;
  case glfnBufferSubData:
    glBufferSubData((GLenum)args->a0, (GLintptr)args->a1, (GLsizeiptr)args->a2,
                    (GLvoid *)parg);
    break;
  case glfnClear:
    ...
    break;
  case glfnClearColor:
    glClearColor(*(GLfloat *)&args->a0, *(GLfloat *)&args->a1,
                 *(GLfloat *)&args->a2, *(GLfloat *)&args->a3);
    break;
  ...
  case glfnLinkProgram:
    ...
    break;
  case glfnReadPixels:
    glReadPixels((GLint)args->a0, (GLint)args->a1, (GLsizei)args->a2,
                 (GLsizei)args->a3, (GLenum)args->a4, (GLenum)args->a5,
                 (void *)parg);
    break;
  case glfnScissor:
    glScissor((GLint)args->a0, (GLint)args->a1, (GLint)args->a2,
              (GLint)args->a3);
    break;
  case glfnShaderSource:
#if defined(os_ios) || defined(os_macos)
    glShaderSource((GLuint)args->a0, (GLsizei)args->a1,
                   (const GLchar *const *)args->a2, NULL);
#else
    glShaderSource((GLuint)args->a0, (GLsizei)args->a1,
                   (const GLchar **)args->a2, NULL);
#endif
    break;
  case glfnTexImage2D:
    glTexImage2D((GLenum)args->a0, (GLint)args->a1, (GLint)args->a2,
                 (GLsizei)args->a3, (GLsizei)args->a4,
                 0, // border
                 (GLenum)args->a5, (GLenum)args->a6, (const GLvoid *)parg);
    break;
  ...
  case glfnUniform2f:
    ...
    break;
  case glfnUniform4f:
    glUniform4f((GLint)args->a0, *(GLfloat *)&args->a1, *(GLfloat *)&args->a2,
                *(GLfloat *)&args->a3, *(GLfloat *)&args->a4);
    break;
  case glfnUniform4fv:
  ...
  case glfnVertexAttribPointer:
    glVertexAttribPointer((GLuint)args->a0, (GLint)args->a1, (GLenum)args->a2,
                          (GLboolean)args->a3, (GLsizei)args->a4,
                          (const GLvoid *)args->a5);
    break;
  case glfnViewport:
    glViewport((GLint)args->a0, (GLint)args->a1, (GLint)args->a2,
               (GLint)args->a3);
    break;
  }
  return ret;
